      ...
      body: Stack(
        children: [
          ...
          Padding(
            ...
            child: Row(
                children: const [
                  Text('Lorem ipsum dolor sit amet' , style: TextStyle(color: Colors.white , fontSize: 16),),
                ],
            ),
          ),
           Container(   // curve shape welcome page
                        ...
                        padding: EdgeInsets.all(10),
                         ...
                         buttonType: ButtonType.apple,
                            ...
                            print('click');
                              ...
                              Padding(
                    padding: const EdgeInsets.only(left: 100 , top: 680 , ),
                    child: Row(
                      children: [
